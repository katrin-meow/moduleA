...
В графическом интерфейсе должен быть отрисован следующий функционал:
	Подключение кошелька (MetaMask);
	Отображение всех propose (активных);
	Добавление нового propose;
	Создание голосования;
	Голосование;
	Делегирование голосования (Доступны для просмотра только те делегации, которые были совершены авторизованным на данный момент пользователем); 
	Отображение балансов (Участникам DAO видны только системные токены, другим авторизированным пользователям доступен просмотр только wrap-токена);
	Уведомление пользователей системы о движении предложений в системе.
